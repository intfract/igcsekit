...
<section>
  ...
  <ul>
    <li>
      <strong>ASCII</strong>: it represents characters using 8-bit binary numbers (256 max)
    </li>
    <li>
  ...
  <ul>
    ...
    <li>Nibble: 4 bits</li>
    <li>Byte: 8 bits</li>
    <li>Kibibyte (KiB): 1024 bytes</li>
    <li>Mebibyte (MiB): 1024 KiB</li>
    <li>Gibibyte (GiB): 1024 MiB</li>
    <li>Tebibyte (TiB): 1024 GiB</li>
